...
nomred <- nomred[nomred$CodiGeo %in% c("30510"),]
...
# ara tenim tots els túnels del fitxer de noms geogràfics (nomid)
...
termeen <- c("30510"="tunnel")

qinst <- c("30510"="Q44377")
